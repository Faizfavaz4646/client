...
export default function MarketingPage() {
  return (
    <main className="relative min-h-screen overflow-x-hidden text-slate-50 font-sans bg-[#0a0a0a]">
      ...
      {/* ========================================= */}
      {/* 
        This is the ONLY background declaration for the entire page. 
        It stays fixed while the pure content scrolls over it.
      */}
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .anim-action-btn { animation: popActionBtn 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) forwards 2.0s, pulseOp2 2s infinite 2.4s; opacity: 0; transform: scale(0); }
        ...
        @keyframes pulseOp2 { 0%, 100% { opacity: 1; } 50% { opacity: 0.6; } }
      ...
      {/* Wrapping pure content in a relative wrapper to scroll flawlessly over the fixed background */}
      <div className="relative z-10 w-full">
        ...
        {/* HERO SECTION */}
        {/* ========================================= */}
        {/* Pure content layout: No backgrounds or borders anymore */}
        ...
        <section className="relative w-full px-6 lg:px-8 py-20">
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24 relative z-10">
            ...
            <div className="flex-1 space-y-6 order-1 lg:order-2">
              <h2 className="anim-slide-up text-4xl lg:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-indigo-300 leading-[1.1] tracking-tight translate-y-[30px] opacity-0">
                Crystal Clear <br /> Voice & Video
              </h2>
              <p className="anim-slide-up text-lg lg:text-xl text-slate-400 max-w-lg leading-relaxed translate-y-[30px] opacity-0" style={{ animationDelay: '0.6s' }}>
              ...
              <ul className="space-y-4 mt-8">
                {["Instant drop-in audio channels", "High definition screen sharing", "Low-latency global infrastructure"].map((item, i) => (
                  <li key={i} className={`flex items-center gap-4 text-slate-200 font-medium translate-x-[-20px] opacity-0 anim-slide-right-${i+1}`}>
        ...
        <section id='marketing' className="relative w-full px-6 lg:px-8 py-24">
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24 relative z-10">
            ...
            <div className="flex-1 space-y-6">
              <h2 className="anim-slide-up-txt text-4xl lg:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-teal-200 leading-[1.1] tracking-tight translate-y-[30px]">
                Manage Tasks <br /> At The Speed Of Chat
              </h2>
              <p className="anim-slide-up-txt text-lg lg:text-xl text-slate-400 max-w-lg leading-relaxed translate-y-[30px]" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="pt-4 anim-slide-up-txt translate-y-[30px]" style={{ animationDelay: '0.5s' }}>
        ...
        <section className="relative w-full px-6 lg:px-8 py-24 text-white text-center">
          <div className="max-w-3xl mx-auto space-y-8 relative z-10">
            ...
            <button className="px-8 py-4 rounded-md bg-white text-black font-bold hover:bg-slate-200 transition-colors w-full sm:w-auto text-lg mt-4 shadow-lg shadow-white/10">
